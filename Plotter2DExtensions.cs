...
namespace Microsoft.Research.DynamicDataDisplay
{
	...
	public static class Plotter2DExtensions
	{
        ...
        public static LineGraph AddLineGraph(this Plotter2D plotter, IPointDataSource pointSource,List<MyPointMarker> mpms , double lineThickness, string description)
        {
            var res = AddLineGraph(plotter, pointSource,
                new Pen(new SolidColorBrush(ColorHelper.CreateRandomHsbColor()), lineThickness),
                (PointMarker)null,
		...
		/// <returns></returns>
		[SuppressMessage("Microsoft.Design", "CA1011:ConsiderPassingBaseTypesAsParameters")]
        public static LineAndMarker<MarkerPointsGraph> AddLineGraph(this Plotter2D plotter, IPointDataSource pointSource,PointMarker marker,
                Pen linePen,List<PointMarker> pms, Description description)
		{
			if (pointSource == null)
				throw new ArgumentNullException("pointSource");
